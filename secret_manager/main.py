...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  - secret-manager --project=project --secret-suffix=-test aws --help
  - secret-manager --project=project --secret-suffix=-test gcp --help
    """,
    ...
    aws_provider_parser = provider_subparsers.add_parser(
        ...
        epilog="""
Examples:
  - secret-manager aws --region eu-west-1 create --secrets application cluster external
  - secret-manager aws --region eu-west-1 initialize --secrets application cluster external
  - secret-manager aws --region eu-west-1 import --secrets application cluster external
  - secret-manager aws --region eu-west-1 export --secrets application cluster external
  - secret-manager aws --region eu-west-1 fake --secrets application cluster external
  - secret-manager aws --region eu-west-1 list --secrets application cluster external
  - secret-manager aws --region eu-west-1 details --secrets application cluster external
  - secret-manager aws --region eu-west-1 delete --secret-name external --version 84e8c4e5-27c7-4nov-z9f5-50c398fe4911
  - secret-manager aws --region eu-west-1 diff --secrets external
    """,
        formatter_class=argparse.RawTextHelpFormatter,
    )
    ...
    gcp_provider_parser = provider_subparsers.add_parser(
        ...
        epilog="""
Examples:
  - secret-manager gcp --gcp-project project create --secrets application cluster external
  - secret-manager gcp --gcp-project project initialize --secrets application cluster external
  - secret-manager gcp --gcp-project project import --secrets application cluster external
  - secret-manager gcp --gcp-project project export --secrets application cluster external
  - secret-manager gcp --gcp-project project fake --secrets application cluster external
  - secret-manager gcp --gcp-project project list --secrets application cluster external
  - secret-manager gcp --gcp-project project details --secrets application cluster external
  - secret-manager gcp --gcp-project project delete --secret-name external --version 1
  - secret-manager gcp --gcp-project project diff --secrets external
    """,
        formatter_class=argparse.RawTextHelpFormatter,
    )
    ...
    for provider in [aws_provider_parser, gcp_provider_parser]:
        ...
        create_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] create --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        initialize_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] initialize --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        import_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] import --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        export_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] export --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        fake_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] fake --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        list_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] list --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        detail_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] details --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        delete_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] delete --secret-name application --version <version id>
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        ...
        diff_parser = subparsers.add_parser(
            ...
            epilog="""
Examples:
  - secret-manager [option,...] <provider> [provider_option,...] diff --secrets application cluster external
    """,
            formatter_class=argparse.RawTextHelpFormatter,
        )
